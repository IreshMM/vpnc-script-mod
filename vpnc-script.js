...
case "connect":
	...
	if (env("CISCO_SPLIT_INC") || REDIRECT_GATEWAY_METHOD != 0) {
		...
		var netmask = "255.0.0.0";
		// The default route will be added automatically
		exec("netsh interface ip set address " + env("TUNIDX") + " static " + env("INTERNAL_IP4_ADDRESS") + " " + netmask + " " + internal_gw + " 1");
	}
	...
	exec("route -p delete 0.0.0.0 if " + env("TUNIDX"));
